...
4.
TESTING: is done to make sure the program runs correctly and the output is as expected. Once it works, we move to the next stage

5.
DEPLOYMENT: Saving the file and making it ready to run anywhere with Python. Finally,

6.
MAINTENANCE: ensures the program can be updated later, like changing the message or adding features, so it remains useful.
